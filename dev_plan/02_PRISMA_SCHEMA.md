# Prisma 7 Schema for Founder Sprint Workspace MVP

**Important**: Prisma 7 requires a separate `prisma.config.ts` file. 
The `url` and `directUrl` fields are NO LONGER supported in schema.prisma.

---

## 1. prisma.config.ts (REQUIRED)
...
## 2. prisma/schema.prisma (Complete Schema)
...
|---|-------|------------|-------------|
| 1 | User | users | Core user model |
| 2 | Batch | batches | Program cohort |
| 3 | UserBatch | user_batches | User-Batch relationship |
| 4 | Question | questions | Founder questions |
| 5 | QuestionAttachment | question_attachments | Question file attachments |
| 6 | Answer | answers | Mentor/Admin answers |
| 7 | Summary | summaries | Admin summary (closes question) |
| 8 | OfficeHourSlot | office_hour_slots | Mentor/Admin office hour slots |
| 9 | OfficeHourRequest | office_hour_requests | Founder requests for office hours |
| 10 | Session | sessions | Program sessions |
