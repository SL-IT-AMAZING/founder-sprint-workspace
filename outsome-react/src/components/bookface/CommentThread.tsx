...
export interface CommentThreadProps {
  ...
  onReplyPrivately?: (commentId: string) => void;
...
}> = ({ comment, depth = 0, onUpvote, onReply, onReplyPrivately }) => {
      ...
      <div style={styles.commentItem}>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.actions}>
            ...
            <button style={styles.actionButton} onClick={() => onReplyPrivately?.(comment.id)}>
              Reply Privately
            </button>
          </div>
        </div>
