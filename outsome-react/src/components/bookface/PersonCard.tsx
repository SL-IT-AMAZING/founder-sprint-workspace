...
export const PersonCard: React.FC<PersonCardProps> = ({
  ...
  const styles = {
    ...
    button: {
      ...
      border: isFollowing ? '1px solid #555AB9' : '1px solid #555AB9',
      backgroundColor: isFollowing 
        ? (isButtonHovered ? '#454a9a' : '#555AB9') 
        : (isButtonHovered ? 'rgba(85, 90, 185, 0.05)' : 'transparent'),
      color: isFollowing ? '#ffffff' : '#555AB9',
      whiteSpace: 'nowrap',
    } as React.CSSProperties,
  };
